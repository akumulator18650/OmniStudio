...
RECOMMENDED_MODELS = [
    ...
    {"name": "RealVisXL V4.0 Lightning", "id": "SG161222/RealVisXL_V4.0_Lightning", "desc": "Сверхбыстрая реалистичная модель (Turbo/Lightning), отлично подходящая для NSFW.", "size_gb": 6.5, "req": "GPU: VRAM 8GB+", "load_class": "Next-Gen", "safety": "NSFW", "type": "Photo"},
    {"name": "Big Lusty Donut Mix v12", "id": "John6666/biglustydonutmix-nsfw-realism-v12-sdxl", "desc": "Один из лучших миксов для откровенного фотореализма и сложных сцен.", "size_gb": 6.5, "req": "GPU: VRAM 8GB+", "load_class": "Next-Gen", "safety": "NSFW", "type": "Photo"},
